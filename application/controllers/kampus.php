...
class Kampus extends CI_Controller{
    ...
    function tambah_aksi() {
        $this->form_validation->set_rules('nim','NIM','required|min_length[8]|max_legth[8]');
        $this->form_validation->set_rules('nama','Nama','required|alpha|min_length[5]|max_legth[15]');
